...
// Gata pet (master OLED): 2 frames 32x32 - open / pestañeando
static const char PROGMEM gata_open[] = {
    ,
};
static const char PROGMEM gata_close[] = {
    ,
...
static void render_gata(void) {
    ...
    static uint8_t blink_state = 0;  // 0 = ojos abiertos, 1 = pestañeando
    // 200 ms cerrado, 2800 ms abierto
    uint16_t cycle = blink_state ? 200 : 2800;
    if (timer_elapsed(blink_timer) > cycle) {
        blink_state ^= 1;
        blink_timer = timer_read();
    }
    oled_set_cursor(0, 8);
    oled_write_raw_P(blink_state ? gata_close : gata_open, 128);
}
